...
const Footer = () => {
    return (
        <div className='bg-[#151515] py-20'>
            <footer className="footer max-w-7xl mx-auto text-[#F3F3F3] ">
                <aside>
                    <img src={logo} alt="" />
                ...
                <nav>
                    <header className="font-semibold text-lg text-white">About</header>
                ...
                <nav>
                    <header className="font-semibold text-lg text-white">Support</header>
                    <a className="link link-hover">Support Center</a>
                    <a className="link link-hover">Feedback</a>
                    <a className="link link-hover">Accesblity</a>
                </nav>
            </footer>
        </div>
    );
